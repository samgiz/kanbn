...
module.exports = {
  ...
  indexHasOptions (assert, basePath, options = null) {
    ...
    if (options !== null) {
      for (const optionsProperty in options) {
  ...
  taskHasMetadata (assert, basePath, taskId, metadata = null) {
    ...
    if (metadata !== null) {
      for (const metadataProperty in metadata) {
  ...
  taskHasSubTasks (assert, basePath, taskId, subTasks = null) {
    ...
    if (subTasks !== null) {
      for (const assertSubTask of subTasks) {
  ...
  taskHasRelations (assert, basePath, taskId, relations = null) {
    ...
    if (relations !== null) {
      for (const assertRelation of relations) {
  ...
  taskHasComments (assert, basePath, taskId, comments = null) {
    ...
    if (comments !== null) {
      for (const assertComment of comments) {
